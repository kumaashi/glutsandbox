...
struct Screen {
	...
	void ReloadShader() {
		...
		shaders.push_back(new Shader("shader/vs.glsl", "shader/gs.glsl", "shader/fs.glsl"));
		shaders.push_back(new Shader("shader/vs_present.glsl", nullptr, "shader/fs_ssao.glsl"));
